To update the GLM file, run the Makefile, e.g.
...
4. `loadshapes`: https://data.openei.org/s3_viewer?bucket=oedi-data-lake&prefix=nrel-pds-building-stock%2Fend-use-load-profiles-for-us-building-stock%2F
