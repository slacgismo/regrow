                ...
                try:
                    ...
                    for tag in tags:
                        ...
                        if "d2m" in dsi:
                            ...
                            break
                        master_prediction_df = pd.concat([master_prediction_df, 
                                                          pred_df])
                        master_prediction_df.to_csv("C:/Users/kperry/Documents/herbie_forecasts.csv", index=False)
                    ...
                    tries += 1
    # Longer term forecasts: GEFS model
    for date in dates:
        time_horizons = [*range(24,78, 6)]
        for time_horizon in time_horizons:
            ...
            for tag in tags:
                ...
                master_prediction_df = pd.concat([master_prediction_df, pred_df])
            # Convert overall cloud cover to GHI, using PVLib functionality
            #HRRR.cloud_cover_to_ghi_linear(cloud_cover, ghi_clear)