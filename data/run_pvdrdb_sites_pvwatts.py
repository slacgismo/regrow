...
if __name__ == "__main__":
    ...
    data_path = "C:/Users/kperry/Documents/extreme-weather-ca-heatwave/pvwatts_pvdrdb_systems"
    ...
    for idx, row in metadata.iterrows():
        ...
        system_identifier = str(row['system_id'])
        ...
        pdc.to_csv('s3://pvdrdb-transfer/REGROW/pvwatts_pvdrdb_systems/' 
