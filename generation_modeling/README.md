...
- `bus_data.csv`: The bus data comes from the `WECC240_2018_Generation_scheduling.xlsx` file and contains bus names, bus ids, and WECC region identifiers.  

- `generation_data.csv`: This file contains the generator cost data for each generator type at each bus.
