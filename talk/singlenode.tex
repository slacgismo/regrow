...
\item \textbf{MPC:} \\
\hspace{12mm} $-$ use load and renewable forecasts for next $24$ hours\\
...
\item adjusted for $10\%$ shortfall (generation below load)
\EIT
...
\begin{columns}
    ...
    \begin{column}{0.4\textwidth}
        \begin{itemize}
            ...
            \item $3$ GWh enough to reduce shortfall more than a factor of $2$
