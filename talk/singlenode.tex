...
\begin{columns}
    ...
    \begin{column}{0.4\textwidth}
        \begin{itemize}
            \item fossil generation does not change much with storage
            \item fossil costs decrease with storage
        \end{itemize}
    \end{column}
\end{columns}
\end{frame}
...
\begin{columns}
    ...
    \begin{column}{0.33\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=\columnwidth]{./figures/p6.pdf}
        \end{figure}
    \end{column}
\end{columns}
\vfill
...
\item more storage helps decrease curtailment and prevents shortfall
\EIT
\end{frame}
